    ...
    <>
      ...
      >
        <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: 0.22 }} aria-hidden="true">
          <defs>
            <pattern id="topoSHE" width="44" height="44" patternUnits="userSpaceOnUse">
              ...
              <path d="M0 11 Q11 2 22 11 T44 11"  style={{ stroke: "var(--irca-blue-100)" }} strokeWidth="1" fill="none" />
            </pattern>
          </defs>
        ...
        >
          {/* Copy */}
          <div>
            <Eyebrow>Proyectos de Seguridad y Salud</Eyebrow>
            <h1 style={{
      ...
      <section className="px-4 sm:px-6 py-16 md:py-24" style={{ background: "var(--bg-1)", borderTop: "1px solid var(--border-soft)" }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center" style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div>
            ...
            <Photo
              ratio="16/9"
              src="/images/servicios/proyectos-de-seguridad-y-salud/servicio-proyectos-seguridad-irca.webp"
              alt="Evaluación de riesgos laborales de IRCA Consultores en planta"
            />
          </div>
          <div>
      ...
      <section className="px-4 sm:px-6 py-16 md:py-24" style={{ background: "var(--bg-1)" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <Photo
              ratio="4/3"
              src="/images/servicios/proyectos-de-seguridad-y-salud/para-quien-es-paroyectos-seguridad-irca.webp"
              alt="Evaluación de riesgos laborales de IRCA Consultores en planta"
            />
          </div>
        </div>
