      ...
      <section className="px-4 sm:px-6 py-16 md:py-24" style={{ background: "var(--bg-1)", borderTop: "1px solid var(--border-soft)" }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center" style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div>
            ...
            <Photo
              ratio="16/9"
              src="/images/servicios/consultoria-y-supervision-ambiental/servicio-consultoria-administracion-irca.webp"
              alt="Supervisión ambiental de IRCA Consultores en campo"
            />
          </div>
          <div>
      ...
      <section className="px-4 sm:px-6 py-16 md:py-24" style={{ background: "var(--bg-1)" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <Photo
              ratio="4/3"
              src="/images/servicios/consultoria-y-supervision-ambiental/para-quien-es-consultoria-tramites-irca.webp"
              alt="Supervisión ambiental de IRCA Consultores en campo"
            />
          </div>
        </div>
